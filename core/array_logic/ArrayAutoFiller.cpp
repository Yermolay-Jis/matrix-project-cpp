...
ArrayAutoFiller::ArrayAutoFiller(int min, int max) : min_(min), max_(max)
{
    std::random_device rd;
    random_engine.seed(rd());
};

void ArrayAutoFiller::autoFill(std::shared_ptr<ArrayModel> array_model)
{
