	...
	int dataFontSize = 15)       // ������ ������ ������
{
	...
	if (matrix == nullptr || rows <= 0 || cols <= 0) {
		...
		// --- 1. ������ ������ �������� (���������) ---
		if (hFontHeaders) SelectObject(hdc, hFontHeaders); // �������� ����� ��� ����������
		...
		// --- 3. ������ ������ ������� � ����� ---
		if (hFontData) SelectObject(hdc, hFontData); // �������� ����� ��� ������
		SetTextColor(hdc, RGB(255, 255, 255));             // ������ ���� ��� ������
		if (hPenGrid) SelectObject(hdc, hPenGrid);   // �������� ���� ��� ��������� �����
		...
		if (hFontHeaders) DeleteObject(hFontHeaders); // ������� ��������� �����
		if (hFontData) DeleteObject(hFontData);       // ������� ��������� �����
