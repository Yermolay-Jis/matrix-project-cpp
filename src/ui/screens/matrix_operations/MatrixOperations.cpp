...
// {
// 	cursorVision(true);
// 	for (size_t i = x_0; i < x; i++)
// 	{
// 		for (size_t j = y_0; j < y; j++)
// 		{
// 			std::cin.clear();
// 		}
// 	};
...
MatrixOperations::MatrixOperations()
{
	...
	auto matrix_main_menu_view = buildMatrixMainMenuView();
...
ftxui::Component MatrixOperations::buildMatrixMainMenuView()
{
